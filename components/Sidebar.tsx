...
const NavItem: React.FC<{
  ...
  const activeClasses = "text-blue-700 bg-blue-50/80 shadow-sm ring-1 ring-blue-100";
...
const Sidebar: React.FC<SidebarProps> = ({ currentPath: propPath, onNavigate: propNavigate }) => {
  ...
  // Fallback to props for legacy/hybrid support
            ...
            <div className="flex flex-col h-full">
                <div className="flex items-center justify-between h-24 px-6 lg:justify-start">
                    <div className="flex items-center gap-3 text-blue-600">
                       ...
                       <span className="font-bold text-xl text-slate-800 tracking-tight">Forums</span>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-1">
                            ...
                            <NavItem href="/" isActive={currentPath === '/'} onClick={handleNavigate}>
                                <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${currentPath === '/' ? 'text-blue-600' : 'text-slate-400 group-hover:text-slate-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
                                <span>Dashboard</span>
                            </NavItem>
                            </li>
                            <li>
                            <NavItem href="/community" isActive={currentPath === '/community'} onClick={handleNavigate}>
                                <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${currentPath === '/community' ? 'text-blue-600' : 'text-slate-400 group-hover:text-slate-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                             ...
                             <li>
                              <NavItem href="/sales-honor" isActive={currentPath === '/sales-honor'} onClick={handleNavigate}>
                                <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${currentPath === '/sales-honor' ? 'text-blue-600' : 'text-slate-400 group-hover:text-slate-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            ...
                            <li>
                              <NavItem href="/important-notice" isActive={currentPath === '/important-notice'} onClick={handleNavigate}>
                                <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${currentPath === '/important-notice' ? 'text-blue-600' : 'text-slate-400 group-hover:text-slate-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                             ...
                             <li>
                              <NavItem href="/menu" isActive={currentPath === '/menu'} onClick={handleNavigate}>
                                <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${currentPath === '/menu' ? 'text-blue-600' : 'text-slate-400 group-hover:text-slate-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        ...
                        <ul className="space-y-1">
                            <li>
                              <NavItem href="/age-calculator" isActive={currentPath === '/age-calculator'} onClick={handleNavigate}>
                                  <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${currentPath === '/age-calculator' ? 'text-blue-600' : 'text-slate-400 group-hover:text-slate-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>
                                  <span>Age Calculator</span>
                              </NavItem>
                            </li>
                            <li>
                              <NavItem href="/quote-calculator" isActive={currentPath === '/quote-calculator'} onClick={handleNavigate}>
                                  <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${currentPath === '/quote-calculator' ? 'text-blue-600' : 'text-slate-400 group-hover:text-slate-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        ...
                        <ul className="space-y-1">
                            <li>
                              <NavItem href="/profile" isActive={currentPath === '/profile'} onClick={handleNavigate}>
                                  <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${currentPath === '/profile' ? 'text-blue-600' : 'text-slate-400 group-hover:text-slate-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                             ...
                             <li>
                              <NavItem href="/login" isActive={currentPath === '/login'} onClick={handleNavigate}>
                                  <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${currentPath === '/login' ? 'text-blue-600' : 'text-slate-400 group-hover:text-slate-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
