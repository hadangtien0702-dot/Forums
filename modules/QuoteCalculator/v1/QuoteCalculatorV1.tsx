        ...
        <div className="space-y-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                ...
                <div className="bg-white rounded-xl shadow-lg shadow-slate-200/80 p-6 sm:p-8">
                    <h2 className="text-xl font-bold text-slate-800 mb-1">Insurance Program Quote</h2>
                ...
                {/* Results Card */}
                <div className="bg-white rounded-xl shadow-lg shadow-slate-200/80 p-6 sm:p-8 min-h-[400px] flex flex-col">
                    {isLoading && (
