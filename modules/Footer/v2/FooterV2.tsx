  ...
  return (
    <footer className="bg-white text-slate-600 py-12 border-t border-slate-100">
      <div className="max-w-5xl mx-auto px-4 flex flex-col items-center text-center">
        ...
        <nav className="flex flex-wrap justify-center gap-x-8 gap-y-4 mb-8 text-sm font-medium text-slate-800">
            <a href="#" className="hover:text-blue-600 transition-colors">Home</a>
            <a href="#" className="hover:text-blue-600 transition-colors">About</a>
            <a href="#" className="hover:text-blue-600 transition-colors">Services</a>
            <a href="#" className="hover:text-blue-600 transition-colors">Work</a>
        ...
        <p className="text-xs text-slate-400">
            &copy; {new Date().getFullYear()} Minimal Designs. Made with ❤️ in San Francisco.
        </p>
      </div>
    </footer>
  );
