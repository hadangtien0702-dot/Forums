  ...
  return (
    <div className="bg-white rounded-xl shadow-lg shadow-slate-200/80">
      ...
      <div className="p-2 sm:p-3">
         {logs.length === 0 ? (
            <div className="text-center py-10 text-slate-500">No calculation history yet.</div>
          ) : (
              ...
              <table className="w-full text-sm text-left">
                <thead className="text-xs text-slate-500 uppercase">
                  <tr>
                    ...
                    <th className="p-3 font-semibold text-right">Issued Age</th>
                  </tr>
                </thead>
                <tbody>
                  {logs.map((log, index) => (
                    <tr key={index} className="border-b border-slate-100 last:border-b-0">
                      ...
                      <td className="p-3 text-slate-800 font-bold text-right">{log.insuranceAge}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
